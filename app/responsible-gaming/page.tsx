...
export const metadata: Metadata = {
  title: "တာဝန်ယူမှုရှိသော ဂိမ်းကစားခြင်း - Responsible Gaming | Myanmar Casino Reviews",
  description: "တာဝန်ယူမှုရှိသော ဂိမ်းကစားခြင်း လမ်းညွှန် နှင့် အကူအညီ။",
  robots: {
    index: true,
    follow: true,
  },
    ...
    <div className="min-h-screen bg-dark py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-4xl font-bold text-white mb-8">
          <span className="gradient-gold">တာဝန်ယူမှုရှိသော</span>{" "}
          <span className="text-white">ဂိမ်းကစားခြင်း</span>
        </h1>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-white">
                  ဂိမ်းကစားခြင်းသည် စွဲလမ်းနိုင်ပြီး ပျော်ရွှင်မှု အတွက် သာရှိရမည်။
                  ငွေကြေး ပြဿနာများ၊ စိတ်ပိုင်းဆိုင်ရာ ထိခိုက်မှုများ သို့မဟုတ် 
                  မိသားစု ပြဿနာများ ဖြစ်ပေါ်ပါက ဂိမ်းကစားခြင်းကို ရပ်တန့်ရန် လိုအပ်ပါသည်။
                </p>
              </div>
            </div>
          </div>
